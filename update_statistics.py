...
statistics_path = 'lib/presentation/pages/statistics.dart'
            ...
            child: Column(
              children: [
                Container(
                  width: 2,
                  height: 24,
                  color: isFirst ? Colors.transparent : AppColor.border,
                ),
                Container(
                  width: 12,
                  height: 12,
                ...
                Expanded(
                  child: Container(
                    width: 2,
                    color: isLast ? Colors.transparent : AppColor.border,
                  ),
                ),
              ],
            ),
