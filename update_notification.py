...
notification_path = 'lib/presentation/pages/notification.dart'

content = """import 'package:electus_app/core/theme/colors.dart';
    ...
    return GestureDetector(
      ...
      child: Container(
        decoration: BoxDecoration(
          color: entity.isRead ? AppColor.surface : AppColor.surface.withOpacity(0.9),
          borderRadius: BorderRadius.circular(16),
          border: entity.isRead ? null : Border.all(color: AppColor.primary.withOpacity(0.3), width: 1),
          boxShadow: const [
            BoxShadow(
...
with open(notification_path, 'w') as f:
    f.write(content)
print("Updated notification.dart")
